...
public class RESTServisiOrnek {
	...
	@RequestMapping(value="/ogrenci/sil?id=1 ",method = RequestMethod.GET)
	public synchronized Ogrenci ogrenciSil(List<Ogrenci> ogrenciler2, String ad, String soyad) {
		return ogrenciSil(ogrenciler, ad, soyad);
	}
	...
	protected Ogrenci ogrenciSil(int index) {
		return ogrenciler.remove(index);
	}
